...
> **Status izrade:** API je kompletan: provera statusa sistema, autentikacija, termini i rezervacije
> (rezervacija, lista čekanja sa automatskim pomeranjem, otkazivanje sa rokom, prisustvo). Ekrani se dodaju
> u narednim koracima.
