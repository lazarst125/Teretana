...
function osveziZaglavlje(putanja) {
  ...
  const stavke = korisnik === null
    ...
    : korisnik.uloga === TRENER
      ? [['Raspored', '/termini', 'nav-raspored'], ['Moji termini', '/moji-termini', 'nav-moji-termini'], ['Novi termin', '/termini/novi', 'nav-novi-termin']]
      : [['Raspored', '/termini', 'nav-raspored'], ['Moje rezervacije', '/rezervacije', 'nav-moje-rezervacije']];
