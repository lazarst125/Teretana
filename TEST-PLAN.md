...
Pokrivenost se meri za `Teretana.Api` iz obe celine zajedno (`pokrivenost.runsettings`; migracije i generisani
...
| Pristupačnost čitačem ekrana | automatski su pokriveni fokus na neispravno polje i `aria-invalid`; najava promena čitačem ekrana nije automatski testirana |
